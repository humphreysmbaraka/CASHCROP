  ...
  data.append('image', {
    ...
    type: fileType,
      ...
      if(create.ok){
        ...
        navigation.replace('shop' , {shop:shopinfo._id , client:false});
  ...
  const edititem = async function(){
    try{
      ...
      if(create.ok){
        ...
        // navigation.navigate('shop' , {shop:shop._id , client:false});
        navigation.replace('shop' , {shop:shop._id , client:false});
