...
import { VStack, Box, Image, Text, Pressable, Button } from "native-base";
...
<Button colorScheme={'pink'} variant={'outline'} onPress={()=>{
   socket?.emit('test' ,null ,    function(){
    console.log('test event has been received successfully');
  })
}}  >SEND EVENT</Button>
      </VStack>
    </ScrollView>
